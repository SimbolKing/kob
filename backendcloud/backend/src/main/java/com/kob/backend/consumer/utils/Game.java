...
public class Game extends Thread {
    ...
    private void sendAllMessage(String message) {
        if (users.get(playerA.getId()) != null) users.get(playerA.getId()).sendMessage(message);
        if (users.get(playerB.getId()) != null) users.get(playerB.getId()).sendMessage(message);
    }
